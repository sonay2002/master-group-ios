...
function svg(v,n){return `<svg viewBox="0 0 48 48" class="mg-work-icon" aria-hidden="true" focusable="false"><g fill="none" stroke="currentColor" stroke-width="2.9" stroke-linecap="round" stroke-linejoin="round">${P[key(v,n)]}</g></svg>`}
