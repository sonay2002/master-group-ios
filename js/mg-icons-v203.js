/* Master Group v204 — semantic work pictograms, rebuilt from scratch. */
(()=>{
const P={
...
const labels={clean:'Клининг участка',camera:'Видеонаблюдение',plumbing:'Сантехника',electrical:'Электрика',construction:'Строительство',masonry:'Кладочные работы',welding:'Сварка',metal:'Металлоконструкции',paint:'Покраска',aircon:'Кондиционирование',heating:'Отопление',ventilation:'Вентиляция',window:'Окна и двери',roof:'Кровля',finishing:'Отделочные работы',landscape:'Ландшафт',excavator:'Земляные работы',transport:'Вывоз мусора',sewer:'Канализация',water:'Водоснабжение',fence:'Заборы',flooring:'Напольные покрытия',tools:'Ремонт техники',other:'Другие работы'};
P.roof=`<path d="M7 28 24 10l17 18"/><path d="M12 27v12h24V27"/><path d="M21 39V30h6v9"/>`;
function label(v){return labels[key(v)]||''}
window.MGIconSVG=svg; window.MGIconKey=key; window.MGIconLabel=label;
})();
